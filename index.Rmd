...
pacman::p_load(tidyverse, lubridate, readr,highcharter,echarts4r,echarts4r.maps,leaflet,ggmap,leaflet.extras,htmltools,broom,flexdashboard,readr,viridisLite)
...
```{r}
valueBox(scales::dollar(round(sum(summarised_dist_time$total_cost)),prefix = "£"), caption = "Total Rides Cost", color = "orange", icon = "glyphicon glyphicon-credit-card")
...
```{r}
valueBox(scales::number(round(sum(summarised_dist_time$total_time)),suffix = " hrs "), caption = "Total Rides Time", color = "steelblue", icon = "glyphicon glyphicon-time")
